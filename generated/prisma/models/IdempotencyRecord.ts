...
export type IdempotencyRecordWhereInput = {
  ...
  actorId?: Prisma.StringFilter<"IdempotencyRecord"> | string
...
export type IdempotencyRecordWhereUniqueInput = Prisma.AtLeast<{
  actorId_key?: Prisma.IdempotencyRecordActorIdKeyCompoundUniqueInput
  AND?: Prisma.IdempotencyRecordWhereInput | Prisma.IdempotencyRecordWhereInput[]
  OR?: Prisma.IdempotencyRecordWhereInput[]
  NOT?: Prisma.IdempotencyRecordWhereInput | Prisma.IdempotencyRecordWhereInput[]
  actorId?: Prisma.StringFilter<"IdempotencyRecord"> | string
...
export type IdempotencyRecordScalarWhereWithAggregatesInput = {
  ...
  actorId?: Prisma.StringWithAggregatesFilter<"IdempotencyRecord"> | string
...
export type IdempotencyRecordActorIdKeyCompoundUniqueInput = {
  actorId: string
  key: string
}
...
export type IdempotencyRecordOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"actorId" | "key" | "requestHash" | "response" | "createdAt", ExtArgs["result"]["idempotencyRecord"]>
...
export interface IdempotencyRecordDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const idempotencyRecordWithActorIdOnly = await prisma.idempotencyRecord.findMany({ select: { actorId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many IdempotencyRecords and only return the `actorId`
   * const idempotencyRecordWithActorIdOnly = await prisma.idempotencyRecord.createManyAndReturn({
   *   select: { actorId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more IdempotencyRecords and only return the `actorId`
   * const idempotencyRecordWithActorIdOnly = await prisma.idempotencyRecord.updateManyAndReturn({
   *   select: { actorId: true },
   *   where: {
   *     // ... provide filter here
   *   },
